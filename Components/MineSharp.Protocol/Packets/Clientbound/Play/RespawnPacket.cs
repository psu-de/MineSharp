...
public class RespawnPacket : IPacket
{
    ...
    public RespawnPacket(string dimension, string dimensionName, long hashedSeed, sbyte gameMode, byte previousGameMode, bool isDebug,
                         bool   isFlat,    bool   copyMetadata, bool? hasDeathLocation, string? deathDimensionName, Position? deathLocation,
                         int?   portalCooldown)
    {
