...
public class Chat
{
    ...
    public delegate string RuleProvider(string ruleName);
    ...
    private readonly RuleProvider? _translationProvider; 
    
    public Chat(string json, RuleProvider? translationProvider = null)
    {
        this.JSON = json;
