namespace MineSharp.Core.Types
{
    public struct UUID : IEquatable<UUID>
    {
        ...
        {
            this._mostSignificantBits = mostSignificantBits;
            this._leastSignificantBits = leastSignificantBits;
        }
        ...
        public UUID(byte[] b)
        {
            ...
            this._mostSignificantBits = BitConverter.ToInt64(b, 0);
            this._leastSignificantBits = BitConverter.ToInt64(b, 8);
        }

        /// <summary>
        /// The least significant 64 bits of this UUID's 128 bit value.
        /// </summary>
        public long LeastSignificantBits => this._leastSignificantBits;

        /// <summary>
        /// The most significant 64 bits of this UUID's 128 bit value.
        /// </summary>
        public long MostSignificantBits => this._mostSignificantBits;
        ...
        public bool Equals(UUID uuid) => this._mostSignificantBits == uuid._mostSignificantBits && this._leastSignificantBits == uuid._leastSignificantBits;
        ...
        public override string ToString() =>
            ...
            GetDigits(this._mostSignificantBits >> 32, 8) + "-" +
            GetDigits(this._mostSignificantBits >> 16, 4) + "-" +
            GetDigits(this._mostSignificantBits, 4) + "-" +
            GetDigits(this._leastSignificantBits >> 48, 4) + "-" +
            GetDigits(this._leastSignificantBits, 12);
        ...
        {
            var uuidMostSignificantBytes = BitConverter.GetBytes(this._mostSignificantBits);
            var uuidLeastSignificantBytes = BitConverter.GetBytes(this._leastSignificantBits);
            byte[] bytes = {
