...
internal class LanguageData(IDataProvider<LanguageDataBlob> provider)
    : IndexedData<LanguageDataBlob>(provider), ILanguageData
{
    ...
    public string? GetTranslation(string name)
    {
        ...
        return translations.GetValueOrDefault(name);
    }
