...
namespace MineSharp.ConsoleClient.Console.Commands.Windows {
    internal class TakeItemCommand : Command {
        ...
        public TakeItemCommand() {
            ...
            var desc = $"Takes [{CountArgument.Color}]count[/] items of type [{ItemTypeArgument.Color}]itemType[/] from the given window and places them in the inventory.";
            this.Initialize("takeItem", desc, CColor.WindowsCommand, WindowIDArgument, ItemTypeArgument, CountArgument);
        }
        ...
        public override void DoAction(string[] argv, CancellationToken cancellation) {
            ...
            window.TakeItem((int)itemType, count, null, true).Wait(cancellation);
        }
    }
}
